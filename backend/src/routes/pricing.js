...
router.post('/items', authenticateJWT, authorizeRoles('admin'), pricingController.createPricingItem);
...
router.post('/optimize', authenticateJWT, authorizeRoles('admin'), pricingController.optimizePrice);
router.put('/update/:productId', authenticateJWT, authorizeRoles('admin'), pricingController.updatePrice);
